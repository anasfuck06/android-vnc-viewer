...
class FullBufferBitmapData extends AbstractBitmapData {
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#copyRect(android.graphics.Rect, android.graphics.Rect, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#createDrawable()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#drawRect(int, int, int, int, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#offset(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#scrollChanged(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#syncScroll()
	 */
	@Override
	void syncScroll() {
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#updateBitmap(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#validDraw(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractBitmapData#writeFullUpdateRequest(boolean)
	 */
	@Override
