...
public class VncCanvasActivity extends Activity implements View.OnGenericMotionListener {
	...
	class ZoomInputHandler extends AbstractGestureInputHandler {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractInputHandler#getHandlerDescription()
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractInputHandler#getName()
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.VncCanvasActivity.ZoomInputHandler#onKeyDown(int,
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.VncCanvasActivity.ZoomInputHandler#onKeyUp(int,
		 *      android.view.KeyEvent)
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractInputHandler#onTrackballEvent(android.view.MotionEvent)
		 */
		@Override
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			panner.start(-(velocityX / FLING_FACTOR),
					-(velocityY / FLING_FACTOR), new Panner.VelocityUpdater() {
						 ...
						 * (non-Javadoc)
						 * 
						 * @see net.thecybershadow.vnc.Panner.VelocityUpdater#updateVelocity(android.graphics.Point,
						 *      long)
						 */
						@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractGestureInputHandler#onTouchEvent(android.view.MotionEvent)
		 */
		@Override
	...
	class PanMode implements AbstractInputHandler {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractInputHandler#onKeyDown(int,
		 *      android.view.KeyEvent)
		 */
		@Override
		public boolean onKeyDown(int keyCode, KeyEvent evt) {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractInputHandler#onKeyUp(int,
		 *      android.view.KeyEvent)
		 */
		@Override
		public boolean onKeyUp(int keyCode, KeyEvent evt) {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractInputHandler#onTouchEvent(android.view.MotionEvent)
		 */
		@Override
		public boolean onTouchEvent(MotionEvent event) {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see net.thecybershadow.vnc.AbstractInputHandler#handlerDescription()
		 */
		@Override
		public CharSequence getHandlerDescription() {
