...
class ZoomScaling extends AbstractScaling {
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractScaling#zoomIn(net.thecybershadow.vnc.VncCanvasActivity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractScaling#getScale()
	 */
	@Override
	float getScale() {
		return scaling;
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractScaling#zoomOut(net.thecybershadow.vnc.VncCanvasActivity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractScaling#adjust(net.thecybershadow.vnc.VncCanvasActivity, float, float, float)
	 */
	@Override
